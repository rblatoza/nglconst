...
if ( ! function_exists( 'nglconst_get_option' ) ) :
	 ...
	 */
	function nglconst_get_option( $key ) {

		if ( empty( $key ) ) { return; }   // empty key
...
if ( ! function_exists( 'nglconst_get_default_theme_options' ) ) :
	 ...
	 */
	function nglconst_get_default_theme_options() {
